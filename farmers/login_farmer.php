...
<head>
    ...
    <title>AgriLink - Farmer Login</title>
...
<body>
    ...
    <section class="hero">
        <div class="container">
            <h1 class="display-5 fw-bold mb-2">Farmer Login</h1>
            <p class="lead opacity-90 mb-0">
                Welcome back! Continue listing produce and managing your orders.
            </p>
        </div>
    </section>
                ...
                <div class="login-card">
                    <div class="card-body">
                        <div class="text-center mb-4">
                            <i class="fas fa-user-farmer fa-3x text-success mb-3"></i>
                            <p class="text-muted mb-0">
                                Sign in to your farmer account to manage your produce and orders.
                            </p>
                        </div>

                        <?php require_once(ROOT_PATH . "common/alert.php"); ?>

                        <form action="<?= BASE_URL ?>process/process_login_farmer.php" method="post">
                            <div class="mb-4">
                        ...
                        <div class="text-center mt-4 pt-3 border-top">
                            <p class="mb-0 text-muted">
                                ...
                                <a href="<?= BASE_URL ?>farmers/sign_farmer.php" class="text-success fw-medium text-decoration-none">
                                    Register Here
                                </a>
                            </p>
                        </div>
