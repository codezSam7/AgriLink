  ...
  <body>
    ...
    <section class="hero bg-success text-white">
      <div class="container text-center">
        <h1 class="display-4 fw-bold mb-3"> Login As a Farmer </h1>
      </div>
    </section>
        ...
        <div class="col-md-8">
          <div class="p-4">
            <p class="mb-3 text-muted text-center">
              Continue with your farmer profile and list more produce and receive orders.
            </p>
            ...
            <div class="text-center">
              <p>Don't have an account? <a href="sign_farmer.php" class="text-success text-center">Register Here</a></p>
            </div>
          </div>
        </div>
      </div>
