...
<head>
  ...
  <title>AgriLink - Register as Farmer</title>
...
<body>
  ...
  <section class="hero">
    <div class="container">
      <h1 class="display-5 fw-bold mb-2">Join as a Farmer</h1>
      <p class="lead opacity-90 mb-0">
        Create your profile, list fresh produce, and connect directly with buyers.
      </p>
    </div>
  </section>
          ...
          <div class="card-body">
            <div class="text-center mb-4">
              ...
              <p class="text-muted mb-0">
                Create your farmer account to start selling directly to buyers.
              </p>
            </div>

            <?php require_once(ROOT_PATH . "common/alert.php"); ?>

            <form action="<?= BASE_URL ?>process/process_sign_farmer.php" method="post">
              <div class="row g-4">
                <div class="col-md-6">
                ...
                <div class="col-12">
                  <label class="form-label fw-medium">Delivery State</label>
                ...
                <div class="col-12">
                  <label class="form-label fw-medium">Delivery LGA</label>
                ...
                <div class="col-md-6">
                  <label class="form-label fw-medium">Primary Produce</label>
                  <input type="text" name="primary_produce" class="form-control"
                    placeholder="e.g. Tomatoes, Maize, Cassava" />
                </div>

                <div class="col-12">
                  <label class="form-label fw-medium">Short Bio / Farm Description</label>
                  <textarea class="form-control" rows="3" name="bio"
                    placeholder="Tell buyers about your farm and produce..."></textarea>
                </div>
                ...
                <div class="col-12 mt-3">
                  <button type="submit" name="btn" class="btn btn-register btn-success w-100">
                    <i class="fas fa-user-plus me-2"></i> Create Farmer Account
                  </button>
                </div>
              </div>
            </form>
            ...
            <div class="text-center mt-4 pt-3 border-top">
              <p class="mb-0 text-muted">
                ...
                <a href="<?= BASE_URL ?>farmers/login_farmer.php" class="text-success fw-medium text-decoration-none">
                  Login Here
                </a>
              </p>
            </div>
