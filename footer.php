        ...
        <div class="row g-5">
            ...
            <div class="col-lg-3 col-md-6">
                ...
                <div class="d-flex gap-3">
                    <a href="https://www.instagram.com/codezSam7" class="text-white-75 fs-4 hover-social"><i class="bi bi-instagram"></i></a>
                    <a href="https://x.com/codezSam7" class="text-white-75 fs-4 hover-social"><i class="bi bi-twitter-x"></i></a>
                    <a href="https://wa.me/234704297204" class="text-white-75 fs-4 hover-social"><i class="bi bi-whatsapp"></i></a>
                </div>
            </div>
        </div>
