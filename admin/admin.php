    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarNavDropdown">
        <ul class="navbar-nav mx-auto gap-4">
          ...
          <li class="nav-item"><a class="bar-link" href="admin.php">Admin</a></li>
    ...
    <div class="row">
      <aside class="col-md-3 p-4 admin-sidebar">
        ...
        <ul class="nav flex-column mt-4">
          ...
          <li class="nav-item"><a class="nav-link" href="admin_view_farmers.php"><i class="bi bi-people-fill"></i> Manage Farmers</a></li>
