...
<head>
    ...
    <style>
        ...
        .icon-circle { width: 52px; height: 52px; display: inline-flex; align-items: center; justify-content: center; border-radius: 14px; background: var(--light-green); color: var(--brand-green); margin-bottom: 0.6rem; }
        .brand { font-weight: 600; color: var(--brand-green); }
        .nav { padding-left: 0; width: 100%; }
        .nav-link { color: #0a3b2c; padding: 0.8rem 0; border-radius: 10px; display: flex; align-items: center; justify-content: center; gap: 0.6rem; font-weight: 500; transition: all 0.2s ease-in-out; text-decoration:none; }
        .nav-link:hover { background: var(--light-green); color: var(--brand-green); transform: translateX(5px); text-decoration: none; }
        .nav-link.active { background: var(--brand-green); color: #fff !important; }
        .page-content {
            margin-left: 260px;
            padding: 2rem;
        ...
        .page-title { font-weight: 600; color: var(--brand-green); margin-bottom: 1rem; }
        .profile-card {
            background: #fff;
            border-radius: 12px;
        ...
        @media(max-width:768px) {
            ...
            .admin-sidebar { position: relative; width: 100%; height: auto; flex-direction: row; justify-content: space-around; }
            .page-content { margin-left: 0; width: 100%; padding: 1rem; }
    ...
    <aside class="admin-sidebar">
        <div class="sidebar-content">
            ...
            <ul class="nav flex-column">
                ...
                <li class="nav-item"><a class="nav-link active" href="admin_manage_users.php"><i class="fas fa-users"></i> Manage Users</a></li>
                <li class="nav-item"><a class="nav-link" href="admin_manage_orders.php"><i class="fas fa-shopping-cart"></i> Manage Orders</a></li>
                <li class="nav-item"><a class="nav-link" href="admin_manage_category.php"><i class="fas fa-layer-group"></i> Manage Categories</a></li>
            </ul>
            <button class="btn btn-green logout-btn" style="width:100%; margin-top:2rem;">
                <a href="process/process_logout_admin.php" style="color:#fff; text-decoration:none; display:block;"> Logout</a>
            </button>
        </div>
    </aside>
