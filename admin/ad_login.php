...
<head>
    ...
    <title>Admin Login - AgriLink</title>
...
<body>
    ...
    <section class="hero">
        <div class="container">
            <h1 class="display-5 fw-bold mb-2">Admin Login</h1>
            <p class="lead opacity-90 mb-0">
                Access the AgriLink management portal
            </p>
        </div>
    </section>
                    ...
                    <div class="card-body">
                        <div class="text-center mb-4">
                            ...
                            <p class="text-muted mb-0">
                                Sign in to manage farmers, buyers, orders, and the platform.
                            </p>
                        </div>
