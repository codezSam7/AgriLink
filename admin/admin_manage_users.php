...
<body>
  ...
  <main class="page-content">
    ...
    <div class="d-flex justify-content-between align-items-center mb-3 mt-5">
      ...
      <div class="search-bar">
        <input type="text" id="searchInput" placeholder="Search buyer name...">
        <button class="btn btn-success" onclick="filterFarmers()">Search</button>
      </div>
    </div>
          ...
          <div class="col-md-4 farmer-card-wrapper">
            <div class="farmer-card text-center p-3">
              <div class="farmer-info">
                ...
                <a href="admin_farmer_details.php?id=<?= $buyer['buyer_id']; ?>" class="btn btn-success btn-sm px-3"><i class="fas fa-eye"></i> View Details</a>
              </div>
            </div>
          </div>
        <?php } ?>
