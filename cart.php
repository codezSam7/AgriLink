      ...
      <?php } else { ?>
        ...
        ?>
          <div class="cart-item d-flex align-items-center justify-content-between flex-wrap">
            ...
            <div class="text-end mt-3 mt-md-0">
              <a href="<?= BASE_URL ?>process/remove_from_cart.php?cid=<?php echo $item['cid'] ?>" class="btn btn-outline-danger btn-sm me-2">
        ...
        <div class="cart-summary mt-5">
          ...
          <div class="text-end mt-3">
            <a href="<?= BASE_URL ?>checkout.php" class="btn btn-checkout btn-lg px-4">
              Proceed to Checkout
            </a>
          </div>
        </div>

        <a href="<?= BASE_URL ?>process/empty_cart.php" class="btn btn-danger btn-lg mt-3">Empty Cart</a>
