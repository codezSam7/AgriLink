...
<style>
:root { --accent: #0f5132; --accent-2: #1fa97a; }
html, body { margin:0; font-family: "Poppins", system-ui, Roboto, Arial; }
body { background: linear-gradient(90deg,#e8f5e9 0%, #c8e6c9 100%); color:#1b4332; }
.con{ margin-top: 3%; }
